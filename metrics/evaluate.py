...
def get_metrics_rank(d, m, label, pred, top):
    re = pd.DataFrame()
    re['mesh'] = m
    re['drug'] = d
    re['label'] = label
    ...
    mrr = rs_metrics.mrr(re_true, re, k=top, user_col='mesh', item_col='drug')
    ndcg = rs_metrics.ndcg(re_true, re, k=top, user_col='mesh', item_col='drug')
    recall = rs_metrics.recall(re_true, re, k=top, user_col='mesh', item_col='drug')
    hitrate = rs_metrics.hitrate(re_true, re, k=top, user_col='mesh', item_col='drug')
    return mrr, ndcg, recall, hitrate
